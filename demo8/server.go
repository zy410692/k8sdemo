...
func delegateV1beta1AdmitToV1(f admitv1Func) admitv1beta1Func {
	return func(review v1beta1.AdmissionReview) *v1beta1.AdmissionResponse {
		in := v1.AdmissionReview{Request: lib.ConvertAdmissionRequestToV1(review.Request)}
		out := f(in)
		return lib.ConvertAdmissionResponseToV1beta1(out)
	}
}

func servePods(w http.ResponseWriter, r *http.Request) {
	serve(w, r, newDelegateToV1AdmitHandler(lib.AdmitPods))
}
